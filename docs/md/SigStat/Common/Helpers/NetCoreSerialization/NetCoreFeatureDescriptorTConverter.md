...
| Name | Summary | 
| --- | --- | 
| <sub>NetCoreFeatureDescriptorTConverter (  )</sub><img style="cursor:not-allowed;"> width=200/></div>| <sub></sub>| <br>
...
| Name | Summary | 
| --- | --- | 
| <sub>[CanConvert](./Methods/NetCoreFeatureDescriptorTConverter-100664126.md) ( [`Type`](https://docs.microsoft.com/en-us/dotnet/api/System.Type) )</sub><img style="cursor:not-allowed;"> width=200/></div>| <sub></sub>| <br>
