...
| Name | Summary | 
| --- | --- | 
| <img width=200/> <sub>NetCoreFeatureDescriptorDictionaryConverter (  )</sub>| <sub></sub>| <br>
...
| Name | Summary | 
| --- | --- | 
| <img width=200/> <sub>[CanConvert](./Methods/NetCoreFeatureDescriptorDictionaryConverter-100664072.md) ( [`Type`](https://docs.microsoft.com/en-us/dotnet/api/System.Type) )</sub>| <sub></sub>| <br>
