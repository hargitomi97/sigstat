...
| Name | Summary | 
| --- | --- | 
| <sub>NetCoreFeatureDescriptorDictionaryConverter (  )</sub><img style="pointer-events: none;"width=200/></div>| <sub></sub>| <br>
...
| Name | Summary | 
| --- | --- | 
| <sub>[CanConvert](./Methods/NetCoreFeatureDescriptorDictionaryConverter-100664119.md) ( [`Type`](https://docs.microsoft.com/en-us/dotnet/api/System.Type) )</sub><img style="pointer-events: none;"width=200/></div>| <sub></sub>| <br>
