...
| Name | Summary | 
| --- | --- | 
|<img width=200/> <sub>Progress</sub> | <sub>Gets the current progress in percentage.</sub> | <br>
...
| Type | Name | Summary | 
| --- | --- | --- | 
|<img width=200/> <sub>ProgressChanged</sub> | <sub>Invoked whenever the [Helpers.IProgress.Progress](https://github.com/hargitomi97/sigstat/blob/master/docs/md/SigStat/Common/Helpers/IProgress.md) property is changed.</sub> |  | <br>
