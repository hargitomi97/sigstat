...
| Name | Summary | 
| --- | --- | 
| Progress<div style="width: 300px">| Gets the current progress in percentage.<div style="width: 300px">| <br>
...
| Name | Summary | 
| --- | --- | 
| ProgressChanged<div style="width: 300px">| Invoked whenever the [Helpers.IProgress.Progress](https://github.com/hargitomi97/sigstat/blob/master/docs/md/SigStat/Common/Helpers/IProgress.md) property is changed.<div style="width: 300px">| <br>
