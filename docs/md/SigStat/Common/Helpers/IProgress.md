...
| Name | Summary | 
| --- | --- | 
| <sub>Progress</sub><p>&nbsp;</p>| <sub>Gets the current progress in percentage.</sub>| <br>
...
| Name | Summary | 
| --- | --- | 
| <sub>ProgressChanged</sub><p>&nbsp;</p>| <sub>Invoked whenever the [Progress](https://github.com/hargitomi97/sigstat/blob/master/docs/md/SigStat/Common/Helpers/IProgress.md) property is changed.</sub>| <br>
