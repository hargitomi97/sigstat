...
| Name | Summary  |
| ------| -----------:|
| [LogError](./ILoggerObjectExtensions-100663346.md) ( [`ILoggerObject`](./../ILoggerObject.md) obj, [`Exception`](https://docs.microsoft.com/en-us/dotnet/api/System.Exception) exception, [`String`](https://docs.microsoft.com/en-us/dotnet/api/System.String) message, [`Object`](https://docs.microsoft.com/en-us/dotnet/api/System.Object)[] args ) | <img width=225/>Formats and writes an error log message.
