...
Gets the strokes from an online signature with standard features. Note that  the signature has to contain [T](../../docs/mdSigStat/Common/Features.md) and [Pressure](../../docs/mdSigStat/Common/Features.md)
