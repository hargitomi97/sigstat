...
| Name | Summary | 
| --- | --- | 
| <sub>FinalResult</sub><div style="pointer-events:none; cursor:default; width=200;"></div>| <sub>Summarized, final result of the benchmark execution.</sub>| <br>
| <sub>SignerResults</sub><div style="pointer-events:none; cursor:default; width=200;"></div>| <sub>List that contains the [Result](https://github.com/hargitomi97/sigstat/blob/master/docs/md/SigStat/Common/Result.md)s for each [Signer](https://github.com/hargitomi97/sigstat/blob/master/docs/md/SigStat/Common/Signer.md)</sub>| <br>
