...
| void | Transform ( [`Signature`](./../Signature.md) signature ) | Executes transform [Items](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/SigStat/Common/SigStat.Common.Pipeline.SequentialTransformPipeline.Items.md) in sequence.  Passes input features for each.  Output is the output of the last Item in the sequence. | 
