...
| Name | Summary | 
| --- | --- | 
| <sub>DistanceFunction</sub><img width=200 style="cursor:not-allowed;pointer-events:none;"/>| <sub>A function to calculate the distance between two online signature points</sub>| <br>
