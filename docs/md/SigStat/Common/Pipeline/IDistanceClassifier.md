...
| Name | Summary | 
| --- | --- | 
| <sub>DistanceFunction</sub><img style="cursor:not-allowed;"> width=200/></div>| <sub>A function to calculate the distance between two online signature points</sub>| <br>
