...
| Name | Summary | 
| --- | --- | 
| <sub>DistanceFunction</sub><div style="pointer-events:none; cursor:default; width=500px;"></div>| <sub>A function to calculate the distance between two online signature points</sub>| <br>
