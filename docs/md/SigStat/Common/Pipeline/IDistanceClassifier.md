...
| Name | Summary | 
| --- | --- | 
| <sub>DistanceFunction</sub><img width=200 unselectable="on"/>  | <sub>A function to calculate the distance between two online signature points</sub><img width=200 unselectable="on"/>  | <br>
