...
| Name | Summary | 
| --- | --- | 
| <sub>DistanceFunction</sub><div style="z-index: 1; position: absolute;"><img width=200/></div>| <sub>A function to calculate the distance between two online signature points</sub>| <br>
