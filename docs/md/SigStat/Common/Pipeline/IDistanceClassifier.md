...
| Name | Summary | 
| --- | --- | 
| <sub>DistanceFunction</sub><button style="pointer-events: none;">Hover or focus over me too</button>| <sub>A function to calculate the distance between two online signature points</sub>| <br>
