...
| Name | Summary | 
| --- | --- | 
| <sub>DistanceFunction</sub><div pointer-events: none; cursor: default;><img width=200/></div>| <sub>A function to calculate the distance between two online signature points</sub>| <br>
