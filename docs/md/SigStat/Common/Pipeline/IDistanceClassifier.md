...
| Name | Summary | 
| --- | --- | 
| <sub>DistanceFunction</sub><!--aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa-->| <sub>A function to calculate the distance between two online signature points</sub>| <br>
