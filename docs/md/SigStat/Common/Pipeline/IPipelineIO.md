...
| Name | Summary | 
| --- | --- | 
| <sub>PipelineInputs</sub><img width=50>| <sub>A collection of inputs for the pipeline elements</sub>| <br>
| <sub>PipelineOutputs</sub><img width=50>| <sub>A collection of outputs for the pipeline elements</sub>| <br>
