...
| void | Train ( [`List`](https://docs.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1)\<[`Signature`](./../Signature.md)> signatures ) | Trains the verifier with a list of signatures. Uses the [SigStat.Common.Model.Verifier.Pipeline](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/.md) to extract features,  and [SigStat.Common.Model.Verifier.Classifier](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/.md) to find an optimized limit. | 
