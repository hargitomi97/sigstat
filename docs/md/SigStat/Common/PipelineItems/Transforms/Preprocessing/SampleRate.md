...
| Name | Summary | 
| --- | --- | 
| <sub>SampleRate (  )</sub><img width=50>| <sub></sub>| <br>
...
| <sub>samplerate</sub><img width=50>| <sub>Gets or sets the input feature representing the X coordinates of an online signature</sub>| <br>
...
| Name | Summary | 
| --- | --- | 
| <sub>[Transform](./Methods/SampleRate-100663845.md) ( [`Signature`](./../../../Signature.md) )</sub><img width=50>| <sub></sub>| <br>
