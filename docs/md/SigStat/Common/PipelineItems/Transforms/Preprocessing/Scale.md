...
| <sub>NewMaxValue</sub> | <sub>\  NewMaxValue: upper bound of the interval, in which the input feature will be scaled\</sub> | 
| <sub>NewMinValue</sub> | <sub>\  NewMinValue: lower bound of the interval, in which the input feature will be scaled\</sub> | 
