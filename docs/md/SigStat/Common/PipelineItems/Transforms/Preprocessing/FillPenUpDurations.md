...
| [Type](https://docs.microsoft.com/en-us/dotnet/api/System.Type) | InterpolationType | An implementation of [SigStat.Common.PipelineItems.Transforms.Preprocessing.IInterpolation](./Signature.md) | 
