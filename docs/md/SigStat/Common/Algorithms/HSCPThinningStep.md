...
| Type | Name | Summary | 
| --- | --- | --- | 
| [Nullable](https://docs.microsoft.com/en-us/dotnet/api/System.Nullable-1)\<[Boolean](https://docs.microsoft.com/en-us/dotnet/api/System.Boolean)> | ResultChanged | Gets whether the last [SigStat.Common.Algorithms.HSCPThinningStep.Scan(System.Boolean[0:,0:])](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/.md) call was effective. | 
