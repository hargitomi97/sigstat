...
Namespace: [SigStat](../README.md) > [Common](./../README.md) > [Algorithms](./README.md)
...
| Name<div><a href="#"><img width=400></a></div> | Summary<div><a href="#"><img width=475></a></div> | 
| --- | --- | 
| <sub>ResultChanged</sub> | <sub>Gets whether the last [Scan](https://github.com/hargitomi97/sigstat/blob/master/docs/md/SigStat/Common/Algorithms/Methods/Scan.md) call was effective.</sub> | 
