...
| <sub>[EuclideanDistance](./Methods/DtwPy-100664279.md) ( [`Double`](https://docs.microsoft.com/en-us/dotnet/api/System.Double)[], [`Double`](https://docs.microsoft.com/en-us/dotnet/api/System.Double)[] )</sub>| <sub>Calculates the euclidean distance of two vectors</sub>| 
