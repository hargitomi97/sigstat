...
| Name | Summary | 
| --- | --- | 
| <p>&nbsp;</p><sub>[Save](./Methods/ImageSaver-100663929.md) ( [`Signature`](./../Signature.md), [`String`](https://docs.microsoft.com/en-us/dotnet/api/System.String) )</sub><p>&nbsp;</p>| <p>&nbsp;</p><sub>Saves a png image file to the specified `path`.</sub><p>&nbsp;</p>| <br>
