...
| Name | Summary | 
| --- | --- | 
| <div style="width:290px"><sub>[Save](./Methods/ImageSaver-100663886.md) ( [`Signature`](./../Signature.md), [`String`](https://docs.microsoft.com/en-us/dotnet/api/System.String) )</sub></div>| <div style="width:290px"><sub>Saves a png image file to the specified `path`.</sub></div>| <br>
