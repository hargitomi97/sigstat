...
| Name | Summary | 
| --- | --- | 
| [MCYTLoader](./../../../ctor/MCYTLoader-100663887.md) ( [`String`](https://docs.microsoft.com/en-us/dotnet/api/System.String) databasePath, [`Boolean`](https://docs.microsoft.com/en-us/dotnet/api/System.Boolean) standardFeatures ) | Initializes a new instance of the [SigStat.Common.Loaders.MCYTLoader](./../Loaders/MCYTLoader.md) class. | 
