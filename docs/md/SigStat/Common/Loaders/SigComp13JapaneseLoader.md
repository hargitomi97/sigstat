...
| Name | Summary | 
| --- | --- | 
| SigComp13JapaneseLoader ( [`String`](https://docs.microsoft.com/en-us/dotnet/api/System.String) databasePath, [`Boolean`](https://docs.microsoft.com/en-us/dotnet/api/System.Boolean) standardFeatures ) | Initializes a new instance of the [SigStat.Common.Loaders.SigComp13JapaneseLoader](https://github.com/hargitomi97/sigstat/tree/master/docs/md/SigStat/Common/Loaders/SigComp13JapaneseLoader.md) class. | 
