...
| Name | Summary | 
| --- | --- | 
| VerifierBenchmark (  ) | Initializes a new instance of the [SigStat.Common.VerifierBenchmark](./Common/../VerifierBenchmark.md) class.  Sets the [SigStat.Common.Sampler](./Common/../Sampler.md) to the default [SigStat.Common.Framework.Samplers.FirstNSampler](). | 
...
| [Sampler](./Sampler.md) | Sampler | The [SigStat.Common.Sampler](./Common/../Sampler.md) to be used for benchmarking | 
| [Verifier](./Model/Verifier.md) | Verifier | Gets or sets the [SigStat.Common.Model.Verifier](./Common/../Model/Verifier.md) to be benchmarked. | 
