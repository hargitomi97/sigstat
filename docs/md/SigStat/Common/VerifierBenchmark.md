...
| [ILogger](https://docs.microsoft.com/en-us/dotnet/api/Microsoft.Extensions.Logging.ILogger) | Logger | Gets or sets the attached [Logging.ILogger](https://github.com/hargitomi97/sigstat/blob/master/docs/md/.md) object used to log messages. Hands it over to the verifier. | 
