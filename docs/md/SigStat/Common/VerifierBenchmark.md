...
| Name | Summary | 
| --- | --- | 
| [VerifierBenchmark](./../../ctor/VerifierBenchmark-100663381.md) (  ) | Initializes a new instance of the [SigStat.Common.VerifierBenchmark](./VerifierBenchmark.md) class.  Sets the [SigStat.Common.Sampler](./Sampler.md) to the default [SigStat.Common.Framework.Samplers.FirstNSampler](./FirstNSampler.md). | 
