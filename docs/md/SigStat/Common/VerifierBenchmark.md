...
| Name | Summary | 
| --- | --- | 
| VerifierBenchmark (  ) | Initializes a new instance of the [SigStat.Common.VerifierBenchmark](./SigStat/Common/VerifierBenchmark.md) class.  Sets the [SigStat.Common.Sampler](./SigStat/Common/Sampler.md) to the default [SigStat.Common.Framework.Samplers.FirstNSampler](). | 
...
| [Sampler](./Sampler.md) | Sampler | The [SigStat.Common.Sampler](./SigStat/Common/Sampler.md) to be used for benchmarking | 
| [Verifier](./Model/Verifier.md) | Verifier | Gets or sets the [SigStat.Common.Model.Verifier](./SigStat/Common/Model/Verifier.md) to be benchmarked. | 
