...
| Name | Summary | 
| --- | --- | 
| VerifierBenchmark (  ) | Initializes a new instance of the [VerifierBenchmark](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/SigStat/Common/SigStat.Common.VerifierBenchmark.md) class.  Sets the [Sampler](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/SigStat/Common/SigStat.Common.Sampler.md) to the default [FirstNSampler](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/SigStat/Common/SigStat.Common.Framework.Samplers.FirstNSampler.md). | 
...
| [ILogger](https://docs.microsoft.com/en-us/dotnet/api/Microsoft.Extensions.Logging.ILogger) | Logger | Gets or sets the attached [ILogger](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/SigStat/Common/Microsoft.Extensions.Logging.ILogger.md) object used to log messages. Hands it over to the verifier. | 
...
| [Sampler](./Sampler.md) | Sampler | The [Sampler](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/SigStat/Common/SigStat.Common.Sampler.md) to be used for benchmarking | 
| [Verifier](./Model/Verifier.md) | Verifier | Gets or sets the [Verifier](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/SigStat/Common/SigStat.Common.Model.Verifier.md) to be benchmarked. | 
