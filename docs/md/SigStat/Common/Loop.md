...
| Name | Summary | 
| --- | --- | 
| Loop (  ) | Creates a [SigStat.Common.Loop](./Common/../Loop.md) instance | 
| Loop ( [`Single`](https://docs.microsoft.com/en-us/dotnet/api/System.Single) centerX, [`Single`](https://docs.microsoft.com/en-us/dotnet/api/System.Single) centerY ) | Creates a [SigStat.Common.Loop](./Common/../Loop.md) instance and initializes the [SigStat.Common.Loop.Center]() property | 
