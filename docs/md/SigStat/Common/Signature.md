...
| [Origin](./Origin.md) | Origin | Represents our knowledge on the origin of the signature. [SigStat.Common.Origin.Unknown](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/.md) may be used in practice before it is verified. | 
