...
| [Signer](./Signer.md) | Signer | A reference to the [SigStat.Common.Signer](./Common/../Signer.md) who this signature belongs to. (The origin is not constrained to be genuine.) | 
...
| [IEnumerable](https://docs.microsoft.com/en-us/dotnet/api/System.Collections.Generic.IEnumerable-1)\<[FeatureDescriptor](./FeatureDescriptor.md)> | GetFeatureDescriptors (  ) | Gets a collection of [SigStat.Common.FeatureDescriptor](./Common/../FeatureDescriptor.md)s that are used in this signature. | 
