...
| [Origin](./Origin.md) | Origin | Represents our knowledge on the origin of the signature. [SigStat.Common.Origin.Unknown](./Signature.md) may be used in practice before it is verified. | 
| [Signer](./Signer.md) | Signer | A reference to the [SigStat.Common.Signer](./Signature.md) who this signature belongs to. (The origin is not constrained to be genuine.) | 
...
| [IEnumerable](https://docs.microsoft.com/en-us/dotnet/api/System.Collections.Generic.IEnumerable-1)\<[FeatureDescriptor](./FeatureDescriptor.md)> | [GetFeatureDescriptors](./Methods/Signature-100663439.md) (  ) | Gets a collection of [SigStat.Common.FeatureDescriptor](./Signature.md)s that are used in this signature. | 
