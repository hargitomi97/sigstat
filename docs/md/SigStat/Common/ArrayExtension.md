...
| [IEnumerable](https://docs.microsoft.com/en-us/dotnet/api/System.Collections.Generic.IEnumerable-1)\<[Signer](./Signer.md)> | GetValues ( [`Signer`](./ArrayExtension.md)[] array ) | Enumerates all values in a two dimensional array | 
