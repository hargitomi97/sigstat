...
| Name | Summary | 
| --- | --- | 
| [AddConst](./../../../ctor/AddConst-100663602.md) ( [`Double`](https://docs.microsoft.com/en-us/dotnet/api/System.Double) value ) | Initializes a new instance of the `SigStat.Common.Transforms.AddConst` class with specified settings. | 
