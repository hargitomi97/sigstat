...
| --- | --- | 
| <sub>AddConst ( [`Double`](https://docs.microsoft.com/en-us/dotnet/api/System.Double) )</sub> | <sub>Initializes a new instance of the [AddConst](../../../docs/md/SigStat/Common/Transforms/AddConst.md) class with specified settings.</sub> | 
