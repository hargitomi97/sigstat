...
| --- | --- | 
| <sub>Binarization (  )</sub> | <sub>Initializes a new instance of the [Binarization](../../SigStat/Common/Transforms/Binarization.md) class with default settings: Iterative threshold and [Dark](../../docs/md/SigStat/Common/Transforms/Binarization/ForegroundType.md).</sub> | 
