...
| --- | --- | 
| <sub>Binarization (  )</sub> | <sub>Initializes a new instance of the [Binarization](../../docs/mdSigStat/Common/Transforms/Binarization.md) class with default settings: Iterative threshold and [Dark](../../docs/mdSigStat/Common/Transforms/Binarization/ForegroundType.md).</sub> | 
