...
| --- | --- | 
| <sub>Multiply ( [`Double`](https://docs.microsoft.com/en-us/dotnet/api/System.Double) )</sub> | <sub>Initializes a new instance of the [Multiply](../../../docs/md/SigStat/Common/Transforms/Multiply.md) class with specified settings.</sub> | 
