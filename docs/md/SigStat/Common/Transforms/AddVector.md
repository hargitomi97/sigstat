...
| Name | Summary | 
| --- | --- | 
| AddVector ( [`FeatureDescriptor`](./../FeatureDescriptor-1.md)\<[`List`](https://docs.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1)\<[`Double`](https://docs.microsoft.com/en-us/dotnet/api/System.Double)>> vectorFeature ) | Initializes a new instance of the [SigStat.Common.Transforms.AddVector](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/SigStat/Common/Transforms/AddVector) class with a vector feature.  Don't forget to add as many Inputs as the vector's dimension. | 
