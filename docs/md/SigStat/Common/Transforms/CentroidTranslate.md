...
| Name | Summary | 
| --- | --- | 
| CentroidTranslate (  ) | Initializes a new instance of the [SigStat.Common.Transforms.CentroidTranslate](https://github.com/hargitomi97/sigstat/tree/develop/docs/md/SigStat/Common/Transforms/CentroidTranslate) class. | 
