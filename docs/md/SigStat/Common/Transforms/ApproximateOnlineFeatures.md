...
| Name | Summary | 
| --- | --- | 
| <sub>ApproximateOnlineFeatures (  )</sub><img width=100>| <sub></sub>| <br>
...
| Name | Summary | 
| --- | --- | 
| <sub>[Transform](./Methods/ApproximateOnlineFeatures-100663550.md) ( [`Signature`](./../Signature.md) )</sub><img width=100>| <sub></sub>| <br>
