...
| Name | Summary | 
| --- | --- | 
| TimeReset (  )<div style="width: 400px">| Initializes a new instance of the [Transforms.TimeReset](https://github.com/hargitomi97/sigstat/blob/master/docs/md/SigStat/Common/Transforms/TimeReset.md) class.<div style="width: 400px">| <br>
