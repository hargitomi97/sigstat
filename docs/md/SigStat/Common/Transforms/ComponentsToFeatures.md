...
| Name | Summary | 
| --- | --- | 
| <sub>ComponentsToFeatures (  )</sub><img width=160>| <sub></sub>| <br>
...
| Name | Summary | 
| --- | --- | 
| <sub>Button</sub><img width=160>| <sub>Button</sub>| <br>
| <sub>InputComponents</sub><img width=160>| <sub>Components</sub>| <br>
| <sub>X</sub><img width=160>| <sub>X</sub>| <br>
| <sub>Y</sub><img width=160>| <sub>Y</sub>| <br>
...
| Name | Summary | 
| --- | --- | 
| <sub>[Transform](./Methods/ComponentsToFeatures-100663582.md) ( [`Signature`](./../Signature.md) )</sub><img width=160>| <sub></sub>| <br>
