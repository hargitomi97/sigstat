...
- [`BenchmarkResults`](./SigStat/Common/BenchmarkResults.md)
	- Contains the benchmark results of every [SigStat.Common.Signer](./Signature.md) and the summarized final results.
...
- [`Signer`](./SigStat/Common/Signer.md)
	- Represents a person as a [SigStat.Common.Signer.ID](./Signature.md) and a list of [SigStat.Common.Signer.Signatures](./Signature.md).
...
- [`ResampleSamplesCountBased`](./SigStat/Common/PipelineItems/Transforms/Preprocessing/ResampleSamplesCountBased.md)
	- Resamples an online signature to a specific sample count using the specified [SigStat.Common.PipelineItems.Transforms.Preprocessing.IInterpolation](./Signature.md) algorithm
...
- [`IDataSetLoader`](./SigStat/Common/Loaders/IDataSetLoader.md)
	- Exposes a function to enable loading collections of [SigStat.Common.Signer](./Signature.md)s.  Base abstract class: [SigStat.Common.Loaders.DataSetLoader](./Signature.md).
...
- [`MCYTLoader`](./SigStat/Common/Loaders/MCYTLoader.md)
	- [SigStat.Common.Loaders.DataSetLoader](./Signature.md) for the MCYT dataset
- [`SigComp11ChineseLoader`](./SigStat/Common/Loaders/SigComp11ChineseLoader.md)
	- [SigStat.Common.Loaders.DataSetLoader](./Signature.md) for the SigComp11Chinese dataset
- [`SigComp11DutchLoader`](./SigStat/Common/Loaders/SigComp11DutchLoader.md)
	- [SigStat.Common.Loaders.DataSetLoader](./Signature.md) for the SigComp11Dutch dataset
- [`SigComp13JapaneseLoader`](./SigStat/Common/Loaders/SigComp13JapaneseLoader.md)
	- [SigStat.Common.Loaders.DataSetLoader](./Signature.md) for the SigComp13Japanese dataset
- [`SigComp15GermanLoader`](./SigStat/Common/Loaders/SigComp15GermanLoader.md)
	- [SigStat.Common.Loaders.DataSetLoader](./Signature.md) for the SigComp15German dataset
- [`SigComp19OnlineLoader`](./SigStat/Common/Loaders/SigComp19OnlineLoader.md)
	- [SigStat.Common.Loaders.DataSetLoader](./Signature.md) for the SigComp19 dataset
...
- [`RectangleFConverter`](./SigStat/Common/Helpers/Serialization/RectangleFConverter.md)
	- Custom serializer for [System.Drawing.RectangleF](./Signature.md) objects
